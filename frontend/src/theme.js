...
export const STATUS_COLORS = {
  ...
  'Doctor Pending':   { bg: '#E3F2FD', border: '#64B5F6', dot: '#2196F3', label: 'Consultation Pending'   },
  'Doctor Completed': { bg: '#FFFDE7', border: '#FFE082', dot: '#FBC02D', label: 'Consultation Completed' },
